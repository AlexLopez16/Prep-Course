...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  const existe = array.find(e => e === elemento);
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  const sum = resultadosTest.reduce((prev, curr) => prev + curr, 0);
...
function mesesDelAño(array) {
  ...
  // Tu código:
  const newArray = array.filter(mes => mes === "Enero" || mes === "Marzo" || mes === "Noviembre");
